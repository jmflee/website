...
insert into users(username,password,firstName,lastName,email,userType,lastLogin) values ('admin', 'nowayshould you be here','Admin', 'Admin', 'admin@info.com', 'admin', '2015-03-02');
insert into users(username,password,firstName,lastName,email,userType,lastLogin) values ('guest', '123','John', 'Doe', 'john@i.com', 'gamer', '2015-03-02');
